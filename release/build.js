...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_resource__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_App_vue__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_events__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vuex_i18n__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__translations_locales_es__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__translations_locales_fr__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__translations_locales_ar__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_app__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_user__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_messages__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_countries__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_associations__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_donations__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modules_accounts__ = __webpack_require__(32);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_variables__ = __webpack_require__(1);
...
var _Logout = __webpack_require__(86);
...
var _Signup = __webpack_require__(91);
...
var _Associations = __webpack_require__(81);

var _Associations2 = _interopRequireDefault(_Associations);

var _Association = __webpack_require__(80);

var _Association2 = _interopRequireDefault(_Association);

var _Donations = __webpack_require__(82);

var _Donations2 = _interopRequireDefault(_Donations);

var _SolidarityAccount = __webpack_require__(92);
...
var _api_variables = __webpack_require__(1);
...
exports.default = {
  ...
  methods: {
    ...
    getAssociationsFromAPI: function getAssociationsFromAPI() {
      ...
      this.$http.post(url, { POS_id: 1, country: country }).then(function (resp) {
...
var _FBLogin = __webpack_require__(83);

var _FBLogin2 = _interopRequireDefault(_FBLogin);

var _Vids = __webpack_require__(93);

var _Vids2 = _interopRequireDefault(_Vids);
...
exports.default = {
  ...
  computed: {
    ...
    balanceLabelClasses: function balanceLabelClasses() {
      var cs = 'label pull-right fauw-balance-label label-';
...
exports.default = {
  ...
  methods: {
    ...
    sendToMangopay: function sendToMangopay(accessKeyRef, cardRegistrationURL, data, cardNo, expirationDate, CVV, rechargeAccountCallBack) {
      ...
      instance.post(cardRegistrationURL, mangopayData).then(function (resp) {
        rechargeAccountCallBack(resp.data);
      }).catch(function (err) {
        vm.$store.commit("setLoading", false);
...
var _Recharge = __webpack_require__(88);
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/mahdi/YoQuieroAyudar/fundraising-API-user-widget/src/components/Vids.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
var nodeClient = function (request) {
    ...
    var client = __webpack_require__(101);
