...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueResource = __webpack_require__(73);
	...
	_vue2.default.http.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('user_token');

	var SocialSharing = __webpack_require__(179);
	_vue2.default.use(SocialSharing);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    var _ = __webpack_require__(74)(Vue);

	    Vue.url = __webpack_require__(75)(_);
	    Vue.http = __webpack_require__(76)(_);
	    Vue.resource = __webpack_require__(80)(_);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var xhr = __webpack_require__(77);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Messages = __webpack_require__(110);

	var _Messages2 = _interopRequireDefault(_Messages);

	var _Share = __webpack_require__(115);

	var _Share2 = _interopRequireDefault(_Share);

	var _Associations = __webpack_require__(118);

	var _Associations2 = _interopRequireDefault(_Associations);

	var _Association = __webpack_require__(123);

	var _Association2 = _interopRequireDefault(_Association);

	var _Donations = __webpack_require__(128);

	var _Donations2 = _interopRequireDefault(_Donations);

	var _SolidarityAccount = __webpack_require__(131);
	      ...
	      if (rememberMe) {
	        ...
	        if (user_token) {
	          ...
	          if (this.$store.getters.getCurrentState == "") {
	            this.$store.commit("changeCurrentState", "loggedin");
	            return "loggedin";
	          }
	        } else {
	          // no token means not signed in
	          this.$store.commit("changeCurrentState", "login");
	          return "login";
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FBLogin = __webpack_require__(98);
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    updateRemember: function updateRemember(e) {
	      console.log(e);
	      //localStorage.setItem('rememberMe', e.rememberMe.value())
	    },
	...
	exports.default = {
	  ...
	  facebookLogin: function facebookLogin(data, callback) {
	    ...
	    FB.api('/me', 'GET', { 'fields': 'email' }, function (FBResponse) {
	      ...
	      Vue.http.post('fb-login', { email: FBResponse.email, userID: data.userID }).then(function (response) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _messages = __webpack_require__(142);

	var _messages2 = _interopRequireDefault(_messages);

	var _countries = __webpack_require__(143);

	var _countries2 = _interopRequireDefault(_countries);

	var _associations = __webpack_require__(144);

	var _associations2 = _interopRequireDefault(_associations);

	var _donations = __webpack_require__(145);
...
/***/ (function(module, exports) {
	...
	var getters = {
	  ...
	  getPageHistory: function getPageHistory(state) {
	...
	var mutations = {
	  ...
	  setCurrentPage: function setCurrentPage(state, newPage) {
	    state.PageHistory.push(newPage);
	    state.CurrentPage = newPage;
	  },
	  setLoading: function setLoading(state, newValue) {
	    state.loading = newValue;
	  },
	  goToPreviousPage: function goToPreviousPage(state) {
	  ...
	  goToNextPage: function goToNextPage(state) {
	    if (state.NexPage) {
	...
	var actions = {
	  changeCurrentState: function changeCurrentState(context) {
	    context.commit("setCurrentState", context);
	  },
	  changeCurrentPage: function changeCurrentPage(context) {
	    context.commit("setCurrentPage", context);
	  },
	  changeLoading: function changeLoading(context) {
...
/***/ (function(module, exports) {
	...
	var getters = {
	  ...
	  getWarning: function getWarning(state) {
	...
	var actions = {
	  ...
	  warning: function warning(context) {
...
/***/ (function(module, exports) {
	...
	var getters = {
	    getAllCountries: function getAllCountries(state) {
	        return state.list;
	    },
	    ...
	    getOtherCountries: function getOtherCountries(state) {
	    ...
	    getCountryByName: function getCountryByName(state, name) {
	        for (var i = 0; i < state.list.length; i++) {
	    ...
	    getCountryByCode: function getCountryByCode(state, code) {
	        for (var i = 0; i < state.list.length; i++) {
...
/***/ (function(module, exports) {
	...
	var getters = {
	  getAssociations: function getAssociations(state) {
	    return state.list;
	  },
...
/***/ (function(module, exports) {
	...
	var getters = {
	  getDonationsTotal: function getDonationsTotal(state) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(147);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery"] = __webpack_require__(148);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ (function(module, exports) {
	...
	module.exports = "data:application/font-woff;base64,bW9kdWxlLmV4cG9ydHMgPSBfX3dlYnBhY2tfcHVibGljX3BhdGhfXyArICJhZjdhZTUwNWE5ZWVkNTAzZjhiOGU2OTgyMDM2ODczZS53b2ZmMiI7"

/***/ }),
/* 175 */
/***/ (function(module, exports) {

	module.exports = "data:application/font-woff;base64,bW9kdWxlLmV4cG9ydHMgPSBfX3dlYnBhY2tfcHVibGljX3BhdGhfXyArICJmZWU2NmU3MTJhOGEwOGVlZjU4MDVhNDY4OTI5MzJhZC53b2ZmIjs="

/***/ }),
/* 176 */
/***/ (function(module, exports) {

	module.exports = "data:application/octet-stream;base64,bW9kdWxlLmV4cG9ydHMgPSBfX3dlYnBhY2tfcHVibGljX3BhdGhfXyArICJiMDY4NzFmMjgxZmVlNmIyNDFkNjA1ODJhZTkzNjliOS50dGYiOw=="
